...
public interface HttpApiService {
    ...
    Observable<HotFragmentBean> getHotData(
            ...
            @Query("lat")String lat,@Query("limit")String limit,@Query("lng")String lng,
            @Query("movieBundleVersion")String movieBundleVersion,@Query("net")String net,
            @Query("refer")String refer,@Query("token")String token,@Query("utm_campaign")String utm_campaign,
            @Query("utm_content")String utm_content,@Query("utm_medium")String utm_medium,
            @Query("utm_source")String utm_source,@Query("utm_term")String utm_term,
